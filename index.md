...
4. [Random Defense 구성 요소](#Random-Defense-구성-요소)  
 1.[ 구성요소](#구성요소)  
 2.[ 매커니즘](#매커니즘)  
...
6. [개발 요구사항 & 흐름도](#개발-요구사항-및-흐름도)  
 1.[ 요구사항(6Week)](#요구사항6Week)  
 2.[ 요구사항(1Year)](#요구사항1Year)  
...
- 근, 중거리 대상 타깃이며 단일 상대에게 데미지를 준다.  <br>

2. Type B - 보병
<img src="./img/Btypetower.png" width="300">
- 근거리 대상 타깃. 한 개의 타워에 여러명이 있는 형태로 다수를 공격하거나, 한 명의 적을 온 할 경우 집중 공격을 한다. 각각의 데미지는 약하다.  <br>

3. Type C - 전차
<img src="./img/Ctypetower.png" width="300">
- 원거리 대상 타깃. 공격속도가 느리나 데미지가 강하다.  <br>
<br>
...
- 10라운드마다 보스가 나온다. 보스는 처치하기 어렵지만 처치할 경우 많은 보상을 얻을 수 있다. 선택적으로 보스 생성을 할 수 있다. 웨이브 진행중에도 사용이 가능하며 처치시 많은 자원을 준다. 다만 처치에 실패했다면 많은 수의 목숨을 잃는다.
